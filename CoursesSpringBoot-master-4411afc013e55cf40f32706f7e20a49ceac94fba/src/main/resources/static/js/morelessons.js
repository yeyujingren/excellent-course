        ...
        // for(let i in data.data){
          $('.r-main').prepend(`
            <div class="group">
              ...
              <div class="div-cour"></div>
            </div>
            `)
          for (let x of data.data.courses) {
              let url;
              let picture=x.picture.url;
              if(picture == null){
                  url=''
              }else{
                  url = x.picture.url
                    ...
                    // console.log(i)
                    $('.r-main').find(`.div-cour`).append(`
                        <div class="col-md-3 courses">
                        <div class="course">
                          <div class="img">
                             <a href="/single?id=${x.course.id}" title=""><img width="100%" height="100%" src="{url}"></a>
          ...
          // for (let x of data.data.ordinaryCourse) {
          //         // console.log(i)
