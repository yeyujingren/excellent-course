  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="input-group" style="margin-top:25px;">
        ...
        <p style="font-size:12px;color:red;display:none" class="emailWorn"> 邮箱已被占用 </p>
